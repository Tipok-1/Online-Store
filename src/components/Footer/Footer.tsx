...
class Footer extends React.Component {
  render() {
    return <div className="footer"><div style={{ background: 'white', padding: 10, borderRadius: 10, cursor: 'pointer' }}><img style={{ marginBottom: 10 }} src="https://rs.school/images/rs_school_js.svg"></img>
